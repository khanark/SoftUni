const { component } = require('../components/catComponent.js');
const cats = require('../gist/cats');
...
exports.homeView = homeTemplate.replace('{{cats}}', () => cats.map(x => Object.values(x).map(component)).join(''));
